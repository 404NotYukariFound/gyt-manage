...
public class TbNatmehaHealthHyper {
	...
	// 无参构造器
	public TbNatmehaHealthHyper() {
	}

	// 有参构造器，进行属性值的初始化
	public TbNatmehaHealthHyper(Long itemid, String patientId, String respDoctorName, String visitWay, LocalDateTime thisFollowupVisitDate, String psyadjustResult, String complianceResult, String visitEvalResult, LocalDateTime nextFollowupDate, String followupVisitDoctorName, String symptomName, String creater, Timestamp itemcreateat, String updater, Timestamp itemupdateat) {
		this.itemid = itemid;
		this.patientId = patientId;
		this.respDoctorName = respDoctorName;
		this.visitWay = visitWay;
		this.thisFollowupVisitDate = thisFollowupVisitDate;
		this.psyadjustResult = psyadjustResult;
	...
	// 获取 心理调整评价结果 的属性值
	public String getPsyadjustResult() {
		return psyadjustResult;
	}

	// 设置 心理调整评价结果 的属性值
	public void setPsyadjustResult(String psyadjustResult) {
		this.psyadjustResult = psyadjustResult;
	}
